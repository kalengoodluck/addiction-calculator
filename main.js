...
// Add data that can be made visible by a conditional "If, then"; //
//"If total is greater than or less than, then show this data rather than that data" //
// On.click function, linked to <span> //
